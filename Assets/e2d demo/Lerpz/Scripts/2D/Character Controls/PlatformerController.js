...
class PlatformerControllerMovement {
	...
	var initFacingDirection  = true;
	// The speed when walking 
	var walkSpeed = 3.0;
	// when pressing "Fire1" button (control) we start walking
	var runSpeed = 10.0;
...
function Awake () {
	movement.direction = transform.TransformDirection ((movement.initFacingDirection?1:-1) * Vector3.forward);
